          ...
          <div className="mx-auto max-w-4xl text-center">
            ...
            >
              ...
              <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
                ...
                project and discuss how we can collaborate to create something
                amazing.
              </p>
            </motion.div>
          </div>
                ...
                <Card>
                  <CardContent className="p-6">
                    ...
                    <p className="text-sm text-muted-foreground">
                      ...
                      comfortable with different time zones. All communication
                      is in English.
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card>
                  <CardContent className="p-6">
                    ...
                    <p className="text-sm text-muted-foreground">
                      ...
                      all projects. This includes updates, bug fixes, and
                      feature additions.
                    </p>
                  </CardContent>
                </Card>
